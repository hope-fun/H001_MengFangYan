...
var GameInit = (function (_super) {
    ...
    var __egretProto__ = GameInit.prototype;
    ...
    */
     ...
     * 创建Logo场景.
     */
    __egretProto__.createLogoScene = function () {
        var _this = this;
     ...
     * 创建Login场景.
     */
    __egretProto__.createLogoinScene = function () {
        var _this = this;
     ...
     * 创建MainGame场景.
     */
    __egretProto__.createMainGameScene = function () {
        var _this = this;
     ...
     * 创建下方答案文字池.
     */
    __egretProto__.createWord = function (subject, answer) {
...
GameInit.prototype.__class__ = "GameInit";
