...
(function (Model) {
    var IndexDB = (function () {
        ...
        var d = __define,c=IndexDB;p=c.prototype;
        //下载器.
        p.downloader = function (_url, _onCallBack) {
        ...
        //获取本地版本号.(空就下载，非空)
        p.getIndexedDBVersionInfo = function () {
            alert(3);
        };
        //比较版本号(等于，大于，和没有)
        //获取数据源.
        p.getStaticData = function () {
        };
    ...
    egret.registerClass(IndexDB,"Model.IndexDB");
})(Model || (Model = {}));
